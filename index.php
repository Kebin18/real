        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> Lucky Juan </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Restaurant <span class="sr-only"></span></a> </li>
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs">Find food you want, and specials</h5>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose you want food</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Order now</h4> </div>
                        <!-- end:Step -->
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Lucky Juan Restaurant</h4> </div>
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#">Lucky Juan</a> <span>Order Delivery &amp; Take-Out </span> </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>Gueguesangen, Sta. Barbara Pangasinan (near Sta. Barbara inn)</p>
                            <h5>Phone: <a href="tel:09690461585">09690461585</a></h5>
                            <h5>Phone: <a href="tel:09669385319">09669385319</a></h5> </div>
                        </div>
                <!-- bottom footer ends -->
            </div>
        </footer>
